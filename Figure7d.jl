...
# @BSON.save "model_prediction_final_viscPoint8.bson"  pressure_vals extraction_rates



# Pressure histogram
dict=BSON.load("model_prediction_final_viscPoint8.bson")
...
display(fig)
fig.savefig("Figure7d.pdf",  bbox_inches="tight", pad_inches=0.02)
close(fig)
