...
# monitoring_well_node = 194
# injection_extraction_nodes = [275, 487]
...
# @BSON.save "model_prediction_final_extrcationchnage.bson"  pressure_vals extraction_rates



# Pressure histogram
dict=BSON.load("model_prediction_final_extrcationchnage.bson")
...
display(fig)
fig.savefig("Figure7c.pdf",  bbox_inches="tight", pad_inches=0.02)
close(fig)
